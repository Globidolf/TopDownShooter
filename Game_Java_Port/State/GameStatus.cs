...
namespace Game_Java_Port {
	public static class GameStatus {
		...
		public static ulong GetFirstFreeID {
			get {
				return nextID++;
			}
		}
		...
		public static GameMenu getMenu(string Name) {
			return _RegisteredMenus.Find((Menu) => { return Menu.Name.ToString() == Name; });
		}
		...
		public static bool hasMenu(string Name) { return _RegisteredMenus.Exists((Menu) => Menu.Name.ToString() == Name); }
		...
		*/
		...
		public static void init() {
			...
			GameMenu.MenuList[MenuName.MainMenu].isOpen = true;
