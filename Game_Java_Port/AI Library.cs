    ...
    public static class AI_Library {
        ...
        public static Action<NPC> RealPlayer = (me) =>
        {
            ...
            if(MousePos != _LastMousePos) {
                ...
                me.AimDirection = Program.center.angleTo(new Vector2(MousePos.X / Program.D2DContext.Size.Width * Program.width, MousePos.Y / Program.D2DContext.Size.Height * Program.height));
